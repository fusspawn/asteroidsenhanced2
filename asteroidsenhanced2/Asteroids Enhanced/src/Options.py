...
class Options:
    ...
    def __drawScene(self):
        ...
        render_text(self.screen, "Move: Arrow Keys", self.font3, (320, 150), True)
        render_text(self.screen, "Shoot: Space, Left Ctrl, z", self.font3, (320, 170), True)
        render_text(self.screen, "Warp: Left Alt, Right Alt, x", self.font3, (320, 190), True)
        render_text(self.screen, "Missiles: m", self.font3, (320,210),True)
        render_text(self.screen, "Nukes: n", self.font3 ,(320,230),True)
        render_text(self.screen, "ShockWaves: b",self.font3, (320,250),True)
